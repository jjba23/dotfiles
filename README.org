...
If you are a Nix connaisseur, you will have no questions here.

Otherwise, for convenience, an example of how to deploy this config in a fully automated fashion:
#+begin_src bash
